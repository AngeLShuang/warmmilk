...
class PaymentView(APIView):
    ...
    def get(self, request, order_id):
        ...
        try:
            ...
            return Response(ec.ORDER_ERR, status=status.HTTP_400_BAD_REQUEST)
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            subject='一杯热牛奶商城%s' % order_id,  # 标题
            return_url="http://www.milk.site:8080/pay_success.html",  # 支付成功后的回调url
        )
...
class PaymentStatusView(APIView):
    ...
    def put(self, request):
        ...
        if success:
            # 取出一杯热牛奶商城订单编号  再取出支付宝交易号
            order_id = data.get('out_trade_no')  # 一杯热牛奶订单编号
            ...
            return Response(ec.ORDER_ILLEGAL_ERR, status=status.HTTP_403_FORBIDDEN)
